# Multi-Channel Media Plan & Budget Allocation
## Brand: Aashirvaad | Total Budget: ₹50.00 Lakhs
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **YouTube & Connected TV** | 16:9 In-Stream Non-Skip (15s) & Bumper (6s) | 35% | ₹17.50 Lakhs | 48% VTR (View-Through Rate) | Health-Conscious Homemakers |
| **Meta (Instagram & Facebook)** | 9:16 Vertical Video Reels & 1:1 Carousel | 30% | ₹15.00 Lakhs | 1.45% CTR / 2.8x Engagement | Fitness & Clean Eating Seekers |
| **Google Display Network (GDN)** | IAB Display Units (300x250, 728x90, 300x600, 970x250) | 20% | ₹10.00 Lakhs | 0.26% Blended CTR | Contextual & In-Market Shoppers |
| **Quick Commerce (Blinkit/Zepto)** | 1:1 Sponsored Tiles & Category Banners | 15% | ₹7.50 Lakhs | 4.2x ROAS (Return on Ad Spend) | High-Intent 10-Min Shoppers |
